import { Box, Typography, Container, Grid, Card, CardMedia, CardContent, List, ListItemAvatar, ListItem, ListItemIcon, Avatar, ListItemText } from "@mui/material";
                    ...
                    <Grid item key={item.id} xs={12} sm={6} md={6} lg={3}>
                        <Card sx={{height: "100%", display: "flex", flexDirection: "column", boxShadow: "none", backgroundImage: "none", borderRadius: 0,}}>
                            ...
                            >
                                <CardMedia
                                    component="img"
                                    image={item.banner ? `${MEDIA_URL}${item.banner}` : "https://via.placeholder.com/194x106"}
